 ...
 */
  ...
  process calculateBeta {
      ...
      output:
      file "methylation_profiles_with_beta" into methylation_profiles_with_beta

      script:
      if (params.comprehensive) {
        """
        mkdir methylation_profiles_with_beta
        meMerge --input $indir --output methylation_profiles_with_beta --no-file --comprehensive
        """
      } else{
        """
        mkdir methylation_profiles_with_beta
        meMerge --input $indir --output methylation_profiles_with_beta --no-file --no-comprehensive
        """
      }
  }
